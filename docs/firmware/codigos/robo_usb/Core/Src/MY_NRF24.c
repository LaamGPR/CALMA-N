...
//12. Begin function
void NRF24_begin(GPIO_TypeDef *nrfCSNPORT,GPIO_TypeDef *nrfCEPORT, uint16_t nrfCSN_Pin, uint16_t nrfCE_Pin, SPI_HandleTypeDef nrfSPI)
{
	//Copy SPI handle variable
	memcpy(&nrf24_hspi, &nrfSPI, sizeof(nrfSPI));
	//Copy Pins and Port variables
	//nrf24_PORT = nrf24PORT;
	nrf24_CSN_PORT = nrfCSNPORT;
	nrf24_CE_PORT = nrfCEPORT;
